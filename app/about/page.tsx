...
import { BreifcaseIcon, LanguageIcon, LocationIcon, UniversityIcon } from "@/components/icons";
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
      ...
      <Card className="py-4">
        ...
        <p className="text-tiny uppercase font-bold text-center">Ashish Gaurav</p>
      ...
      <ul className="gap-2 grid grid-cols-1 md:grid-cols-2 px-8 list-none">
        ...
        <CardBody>
          ...
          <p>
            ...
            <a className="text-primary" href="mailto:ashish.gaurav2003@gmail.com">ashish.gaurav2003@gmail.com</a>
          </p>  
          <p>
        ...
        <CardBody>
          ...
          <p>
            FrontEnd Devlopment of 25+ Webpage based on Figma Designs. Buit with pure HTML, CSS and JS
          </p>
          <p className="mt-2">
            <BreifcaseIcon className="inline-block mr-2" />
            <span className="text-default-500">VRAIO Software Solutions Pvt Ltd</span>
          </p>
        </CardBody>
          </Card>
        </li>
