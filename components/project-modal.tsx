                ...
                <div className="flex flex-wrap gap-3">
                  {project.storeLinks.map((store) => (
                    <a
                      ...
                      className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-sm font-medium hover:opacity-90 transition-opacity"
                    >
                      {store.label}
                      <svg
