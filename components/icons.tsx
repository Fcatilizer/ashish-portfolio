...
export const UniversityIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
  ...
  return (
    ...
    >
      <path
        d="M12 2L1 7l11 5 11-5-11-5zM5.5 8.5L12 11l6.5-2.5L12 6 5.5 8.5zM12 14l-6.5 2.5L12 19l6.5-2.5L12 14z"
        fill="currentColor"
      />
    </svg>
  );
...
export const BreifcaseIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    ...
    >
      <path
        d="M21 6h-3V5c0-1.11-.89-2-2-2H8c-1.11 0-2 .89-2 2v1H3c-1.11 0-2 .89-2 2v11c0 1.11.89 2 2 2h18c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zM8 5h8v1H8V5zm12 14H4V9h16v10z"
        fill="currentColor"
      />
    </svg>
  );
