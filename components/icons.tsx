...
export const OpenFolderIcon = (props: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
  ...
  >
    <path
      d="M3 8.5C3 7.11929 4.11929 6 5.5 6H10.4142C10.7467 6 11.0661 6.10536 11.3189 6.29289L12.4142 7.20711C12.667 7.39464 12.9864 7.5 13.3189 7.5H18.5C19.8807 7.5 21 8.61929 21 10V16C21 17.3807 19.8807 18.5 18.5 18.5H5.5C4.11929 18.5 3 17.3807 3 16V8.5Z"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2}
